...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-upq7ati.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-upq7ati.containers.anotherwebservice.com/
...
```
git clone git@github.com:choice21hax/container-upq7ati.git
cd container-upq7ati
```
...
```
docker attach container-upq7ati
```
